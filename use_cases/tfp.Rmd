...
- **Differences in sample restrictions**. We remove firms with gaps in data in 2012-2018. This is reasonable as it is impossible to calculate the investment proxy variable defined as first difference in capital when capital is unknown any of adjacent years. We do not know how 
