...
Despite our efforts to replicate the target study filtering procedures, the RFSD has slightly more firms than SPARK each year. This may be due to data completeness issues with SPARK, differences in the outlier filtering procedure of MMPTT, or differences in the definition of financial firms between SPARK and the RFSD.
...
The medians are identical, while the means are slightly different. We explain this discrepancy by differences in the outlier filtering procedures between the target study and our replication which we cannot account for here as they are undocumented.
